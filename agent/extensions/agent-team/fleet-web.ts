...
function appendActualToolDiff(parent, value) {
	for (const line of value.split("\\n")) {
		if (line.startsWith("-") && !line.startsWith("---")) appendDiffLine(parent, "delete", line.slice(1));
		else if (line.startsWith("+") && !line.startsWith("+++")) appendDiffLine(parent, "add", line.slice(1));
		else appendDiffLine(parent, "context", line);
	}
}
